module.exports = {
  ...
  etat_pastell : {
    "accepter-sae" :	"L'archive a été acceptée par le SAE",
    "ar-recu-sae" :	"Pastell a receptionné l'accusé de réception du SAE.",
    "cheminement-change" : "???????",
    "creation" :	"Le document est en cours de création sur Pastell.",
    "erreur-envoie-sae" :	"Une erreur est survenue lors de l'envoi de l'achive au SAE.",
    "erreur-verif-iparapheur" :	"Une erreur est survenie lors de la vérification du statut de signature sur l'i-parapheur.",
    "error-ged" :	"Une erreur est survenue lors du dépôt en GED.",
    "importation" :	"?????????",
